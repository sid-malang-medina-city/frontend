<template>
  <div class="manajemen-vendor-create">
    <page-header
    ...
    <div class="page-content">
      <div class="manajemen-vendor-create__wrapper">
        <div class="manajemen-vendor-create__input-section input-section">
        ...
        <div class="manajemen-vendor-create__submit-section">
          <el-button
            :disabled="!isAllRequiredFieldsFilled"
            :loading="visibleLoading"
            type="primary"
            class="manajemen-vendor-create__submit-btn"
            @click="submit"
          >
            Buat Vendor
          </el-button>
...
<script src="./js/manajemen-vendor-create.js"></script>

<style lang="scss" scoped>
@import "~/assets/scss/main.scss";

  .manajemen-vendor-create {
    &__wrapper {
      background: white;
      border-radius: 12px;
