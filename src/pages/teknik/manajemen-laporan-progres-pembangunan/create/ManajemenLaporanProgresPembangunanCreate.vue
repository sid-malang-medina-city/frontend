<template>
  <div class="manajemen-laporan-progres-pembangunan-create">
    <page-header
      title="Buat Laporan Progres Pembangunan Baru"
      show-back-icon
      @back="goToManajemenLaporanProgresPembangunan"
    />

    <div class="page-content">
      <div class="manajemen-laporan-progres-pembangunan-create__wrapper">
        <div class="manajemen-laporan-progres-pembangunan-create__input-section input-section">
          ...
          <div class="input-section__rows rows">
            ...
            <div class="rows__row">
              ...
              <el-input
                ...
                :parser="(value) => value.replace(/[^\d,]/g, '')"
                placeholder="Masukkan harga total bulan ini pembulatan"
                class="row__input"
              />
            </div>
          </div>
        ...
        <div class="manajemen-laporan-progres-pembangunan-create__submit-section">
          <el-button
            ...
            @click="submit"
          >
            Buat Laporan Progres Pembangunan
          </el-button>
        </div>
      </div>
    </div>
...
<script src="./js/manajemen-laporan-progres-pembangunan-create.js"></script>

<style lang="scss" scoped>
@import "~/assets/scss/main.scss";
@import "~/assets/scss/table.scss";

  .manajemen-laporan-progres-pembangunan-create {
    &__wrapper {
      background: white;
      border-radius: 12px;
