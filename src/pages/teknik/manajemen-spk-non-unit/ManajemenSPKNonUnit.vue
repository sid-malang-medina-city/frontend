<template>
  <div class="manajemen-spk-non-unit">
    <page-header title="Manajemen SPK Non Unit" />
    <div class="manajemen-spk-non-unit__wrapper page-content">
      <div class="manajemen-spk-non-unit__actions-wrapper">
        <div class="manajemen-spk-non-unit__actions actions">
          ...
          <el-button
            v-if="hasAccess('CREATE_SPK_NON_UNIT')"
            type="primary"
        ...
        <div
          ...
          class="manajemen-spk-non-unit__filters filters"
        >
          <div class="filters__input-wrapper">
            ...
            <el-input
              ...
              placeholder="Cari berdasarkan no SPK Non Unit"
      ...
      <div class="manajemen-spk-non-unit__table-wrapper">
        <el-table
          v-loading="visibleLoadingTable"
          :data="SPKNonUnits"
          class="manajemen-spk-non-unit__table table general-table"
        ...
        >
          ...
          <el-table-column
            v-if="hasAccess('UPDATE_SPK_NON_UNIT')"
            label="Action"
            width="90"
            align="center"
            fixed="right"
                ...
                <el-dropdown trigger="click">
                  ...
                  <template #dropdown>
                    <el-dropdown-menu class="actions__dropdown-menu">
                      ...
                      <el-dropdown-item @click="generateSPKNonUnitPDF(scope.row.id)">PDF</el-dropdown-item>
                      <div
                        v-if="!!scope.row.spk_non_unit_access_url"
                      ...
                      <el-dropdown-item v-if="!!scope.row.spk_non_unit_access_url" @click="openDocumentInNewTab(scope.row.spk_non_unit_access_url)">
                        PDF
                      </el-dropdown-item>
                      <div
                        v-if="hasAccess('UPDATE_SPK_NON_UNIT') && scope.row.status !== 'FINAL'"
        ...
        <div class="manajemen-spk-non-unit__footer">
          <div class="manajemen-spk-non-unit__total-spk-non-units font-grey">
            Menampilkan {{ totalShownSPKNonUnits }} dari {{ totalSPKNonUnits }} SPK Non Unit
          </div>
          <div class="manajemen-spk-non-unit__pagination">
            <el-pagination
              :current-page="pagination.page"
              :page-size="pagination.size"
              :total="totalSPKNonUnits"
...
<script src="./js/manajemen-spk-non-unit.js"></script>

<style lang="scss" scoped>
@import "~/assets/scss/main.scss";
@import "~/assets/scss/table.scss";

  .manajemen-spk-non-unit {
    &__actions-wrapper {
      border-radius: 12px;
