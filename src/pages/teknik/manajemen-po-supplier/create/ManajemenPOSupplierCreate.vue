<template>
  <div class="manajemen-po-supplier-create">
    <page-header
    ...
    <div class="page-content">
      <div class="manajemen-po-supplier-create__wrapper">
        <div class="manajemen-po-supplier-create__input-section input-section">
        ...
        <div class="manajemen-po-supplier-create__submit-section">
          <el-button
            :disabled="!isAllRequiredFieldsFilled"
            :loading="visibleLoading.submitButton"
            type="primary"
            class="manajemen-po-supplier-create__submit-btn"
            @click="submit"
          >
            Buat PO Supplier
          </el-button>
    ...
    <el-drawer
      ...
      :size="800"
      class="manajemen-po-supplier-create__drawer drawer"
    >
      <template #header>
...
<script src="./js/manajemen-po-supplier-create.js"></script>

<style lang="scss" scoped>
@import "~/assets/scss/main.scss";
@import "~/assets/scss/table.scss";

  .manajemen-po-supplier-create {
    &__wrapper {
      background: white;
      border-radius: 12px;
