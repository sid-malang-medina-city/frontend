<template>
  <div class="manajemen-spk-create">
    <page-header
      title="Buat SPK Baru"
      show-back-icon
    ...
    <div class="page-content">
      <div class="manajemen-spk-create__wrapper">
        <div class="manajemen-spk-create__input-section input-section">
    ...
    <el-drawer
      ...
      :size="800"
      class="manajemen-spk-create__drawer drawer"
    >
      <template #header>
    ...
    <el-dialog
      ...
      :width="480"
      class="manajemen-spk-create__dialog dialog"
    >
      <template #header>
...
<script src="./js/manajemen-spk-create.js"></script>

<style lang="scss" scoped>
@import "~/assets/scss/main.scss";
@import "~/assets/scss/table.scss";

  .manajemen-spk-create {
    &__wrapper {
      background: white;
      border-radius: 12px;
