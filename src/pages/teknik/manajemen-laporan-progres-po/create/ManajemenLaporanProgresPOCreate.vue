<template>
  <div class="manajemen-laporan-progres-po-create">
    <page-header
      title="Buat Laporan Progres PO Baru"
      show-back-icon
      @back="goToManajemenLaporanProgresPO"
    />

    <div class="page-content">
      <div class="manajemen-laporan-progres-po-create__wrapper">
        <div class="manajemen-laporan-progres-po-create__input-section input-section">
        ...
        <div class="manajemen-laporan-progres-po-create__submit-section">
          <el-button
            :disabled="!isAllRequiredFieldsFilled"
            :loading="visibleLoading.submitButton"
            type="primary"
            class="manajemen-laporan-progres-po-create__submit-btn"
            @click="submit"
          >
            Buat Laporan Progres PO
          </el-button>
        </div>
      </div>
    </div>
    ...
    <el-drawer
      ...
      :size="800"
      class="manajemen-laporan-progres-po-create__drawer drawer"
    >
      <template #header>
...
<script src="./js/manajemen-laporan-progres-po-create.js"></script>

<style lang="scss" scoped>
@import "~/assets/scss/main.scss";
@import "~/assets/scss/table.scss";

  .manajemen-laporan-progres-po-create {
    &__wrapper {
      background: white;
      border-radius: 12px;
