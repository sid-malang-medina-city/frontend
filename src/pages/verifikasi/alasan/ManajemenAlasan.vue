<template>
  <div class="manajemen-alasan">
    <page-header title="Manajemen Alasan" />
    <div class="manajemen-alasan__wrapper page-content">
      <div class="manajemen-alasan__actions-wrapper">
        <div class="manajemen-alasan__actions actions">
          <el-button
            type="secondary"
        ...
        >
          <div class="filters__input-wrapper">
            ...
            <el-input
              ...
              placeholder="Cari alasan berdasarkan nama"
      ...
      <div class="manajemen-alasan__table-wrapper">
        <el-table
          v-loading="visibleLoadingTable"
          :data="alasans"
          class="manajemen-alasan__table table general-table"
...
<script src="./js/manajemen-alasan.js"></script>
