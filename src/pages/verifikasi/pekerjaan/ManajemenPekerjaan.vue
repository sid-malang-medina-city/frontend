<template>
  <div class="manajemen-pekerjaan">
    <page-header title="Manajemen Pekerjaan" />
    <div class="manajemen-pekerjaan__wrapper page-content">
      <div class="manajemen-pekerjaan__actions-wrapper">
        <div class="manajemen-pekerjaan__actions actions">
          <el-button
            type="secondary"
        ...
        <div
          v-if="visibleFilter"
          class="manajemen-pekerjaan__filters filters"
        >
      ...
      <div class="manajemen-pekerjaan__table-wrapper">
        <el-table
          v-loading="visibleLoadingTable"
          :data="pekerjaans"
          class="manajemen-pekerjaan__table table general-table"
...
<script src="./js/manajemen-pekerjaan.js"></script>
