...
export default {
  ...
  methods: {
    ...
    async generatePDF(laporanInvoice) {
      ...
      doc.setFontSize(12).text(laporanInvoice.konsumen_nama, 90, currentY)
      currentY += 7
      doc.setFontSize(12).text('Alamat Rumah', 44, currentY)
      doc.setFontSize(12).text(':', 84, currentY)
      doc.setFontSize(12).text(laporanInvoice.konsumen_alamat, 90, currentY)
      currentY += 7
      doc.setFontSize(12).text('No. Telp/HP', 44, currentY)
      doc.setFontSize(12).text(':', 84, currentY)
      doc.setFontSize(12).text(laporanInvoice.konsumen_nomor_telepon, 90, currentY)
      currentY += 7
      doc.setFontSize(12).text('Cluster Unit', 44, currentY)
      doc.setFontSize(12).text(':', 84, currentY)
      doc.setFontSize(12).text(laporanInvoice.unit_cluster_nama, 90, currentY)
      currentY += 7
      doc.setFontSize(12).text('Nomor Kavling', 44, currentY)
      doc.setFontSize(12).text(':', 84, currentY)
      doc.setFontSize(12).text(laporanInvoice.unit_nomor_kavling, 90, currentY)
      currentY += 7
      doc.setFontSize(12).text('Bangunan', 44, currentY)
      doc.setFontSize(12).text(':', 84, currentY)
      doc.setFontSize(12).text(laporanInvoice.unit_tipe, 90, currentY)
      currentY += 12
      ...
      doc.setFontSize(12).text(':', 84, currentY)
      doc.setFontSize(12).text(laporanInvoice.laporan_marketing.marketer.nama, 90, currentY)
      currentY += 7
      doc.setFontSize(12).text('Alamat Rumah', 44, currentY)
      doc.setFontSize(12).text(':', 84, currentY)
      doc.setFontSize(12).text(laporanInvoice.laporan_marketing.marketer.alamat, 90, currentY)
      currentY += 7
      doc.setFontSize(12).text('No. Telp/HP', 44, currentY)
      doc.setFontSize(12).text(':', 84, currentY)
      doc.setFontSize(12).text(laporanInvoice.laporan_marketing.marketer.nomor_telepon, 90, currentY)
      currentY += 12
      ...
      doc.setFontSize(12).text(':', 84, currentY)
      doc.setFontSize(12).text(helpers.convertPriceToRupiah(laporanInvoice.laporan_marketing.jumlah_fee), 90, currentY)
      currentY += 7
      doc.setFontSize(12).text('NPWP', 44, currentY)
      doc.setFontSize(12).text(':', 84, currentY)
      doc.setFontSize(12).text(laporanInvoice.laporan_marketing.marketer.npwp, 90, currentY)
      currentY += 7
      doc.setFontSize(12).text('Nomor Rekening', 44, currentY)
      doc.setFontSize(12).text(':', 84, currentY)
      doc.setFontSize(12).text(laporanInvoice.laporan_marketing.marketer.nomor_rekening, 90, currentY)
      currentY += 7
      doc.setFontSize(12).text('Nama Bank', 44, currentY)
      doc.setFontSize(12).text(':', 84, currentY)
      doc.setFontSize(12).text(laporanInvoice.laporan_marketing.marketer.rekening_bank, 90, currentY)
      currentY += 7
      doc.setFontSize(12).text('Atas Nama', 44, currentY)
      doc.setFontSize(12).text(':', 84, currentY)
      doc.setFontSize(12).text(laporanInvoice.laporan_marketing.marketer.nama_rekening, 90, currentY)
      currentY += 10
